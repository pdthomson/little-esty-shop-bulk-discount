Rails.application.routes.draw do
  ...
  get '/merchants/:merchant_id/bulk_discounts/:discount_id/edit', to: 'bulk_discounts#edit'
  post '/merchants/:merchant_id/bulk_discounts/new', to: 'bulk_discounts#create'
  delete '/merchants/:merchant_id/bulk_discounts/:discount_id', to: 'bulk_discounts#delete'
  patch '/merchants/:merchant_id/bulk_discounts/:discount_id', to: 'bulk_discounts#update'
end
